...
function [ spk, rc ] = load_spk_from_dat( filebase, shanknum, clunum, spksuffix, clusuffix, resoffset )
...
NSAMPLES = 64;      % in case not defined in the par file. Set at 0 to use par values or default (32)
Fs0 = 20000;
