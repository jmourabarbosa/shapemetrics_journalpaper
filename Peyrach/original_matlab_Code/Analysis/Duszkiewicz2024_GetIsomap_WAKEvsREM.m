...
if iso == 0    
    ...
    mapping = compute_mapping(dq_res, 'Isomap',2); % run the Isomap script
...
% Save your work
if iso == 1
    SaveAnalysis(pwd,'Isomap_REMvsWK',{Qrw; mapping; ixHd; ixWk; ixRem; tcReal; tcWk; tcRem; B},{'Qrw'; 'mapping'; 'ixHd'; 'ixWk'; 'ixRem'; 'hReal'; 'hWk'; 'hRem'; 'B'});
end
