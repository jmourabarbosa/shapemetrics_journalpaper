...
SaveAnalysis(pwd,'GLM_RemWake_Rev',{pairs, beta_rem, beta_wake, lagVec, warn_wake, warn_rem},{'pairs_rev', 'beta_rem_rev','beta_wake_rev', 'bins', 'warn_wake_rev', 'warn_rem_rev'});
...
% load additional data
    load(fullfile('Analysis','GLM_RemWake_Rev'));
    ...
    epRem = intervalSet(rem(:,1),rem(:,2));
    epWake = wake1Ep; % CHANGE DEPENDING ON REC!!!
